    ...
    function validerFormulaire(event) {
        ...
        if (champNom.value === "" && champPrenom.value === "" && champAdresse.value === "" && champEmail.value === "" && champDate.value === "") {
            ...
            if (Total !== "") {
                ...
                linkToGoogleMaps.target = "_blank"; // ouvre dans un nouvel onglet
                linkToGoogleMaps.style.textDecoration = "none"; // optionnel : retire le soulignement
                linkToGoogleMaps.style.color = "blue";
